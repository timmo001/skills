---
name: effect
description: Work with Effect v4 / effect-smol TypeScript code. Use when writing, reviewing, or refactoring TypeScript code using the Effect library (Effect.gen, Context.Tag, Layer, Schema, Effect.fn).
# origin: https://github.com/anomalyco/opencode/tree/dev/.opencode/skills/effect
# upstream-sha: 4fe14abb8cd34b8af20d31b656715fd140fa4eed
---
