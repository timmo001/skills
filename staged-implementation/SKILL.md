...
8. When blocked work needs another attempt, prepare a compact handoff containing the active contract, current diff state, validation evidence, and unresolved findings.
